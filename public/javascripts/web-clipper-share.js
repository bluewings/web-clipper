...
(function () {
    ...
    CONFIG = {
        ...
        REMOTE_HOST: 'http://10.64.51.102:2000'
    };
    ...
    function initNgModule(elen) {
        ...
        app = angular.module('web-clipper-widget', ['webClipper', 'ngAnimate', 'ngSanitize']);
        ...
        app.filter('highlight', function () {
            ...
            return function (text, needle) {
                ...
                console.log(text.replace(needle, '<strong>' + needle + '</strong>'));

                return text.replace(needle, '<span class="hl">' + needle + '</span>');
        ...
        app.controller('clipper-main', function ($scope, $element, $http, $timeout, clipUtil, clipCache) {
            ...
            $(document.body).bind('mouseup', function () {
                ...
                if (range.startContainer === range.endContainer && Math.abs(range.endOffset - range.startOffset) < 4) {
                    //세즐자 이상 선택
            ...
            $scope.func = {
                fork: function () {
                    ...
                    var uniqueString = "uniq" + parseInt(Math.random() * 10000);
                    ...
                    form.action = "http://10.64.51.102:2000/fork";
                    form.method = "POST";
                    ...
                    input.type = "hidden";
                    input.name = "json_string";
                    input.value = JSON.stringify($scope.data.pages);
                    ...
                    $(window).one('message', function (event) {
                        ...
                        if (matches) {
                            ...
                            $scope.$apply(function () {
                                ...
                                $scope.data.url = 'http://10.64.51.102:2000/share/' + matches[1];
                ...
                moveToSelection: function (sel) {

                    var node = clipUtil.getNode(sel.start.nodePath),
                    ...
                    body.animate({
                        ...
                        scrollTop: rectList[0].top + scrollTop - 20
                ...
                removeSelection: function (sel) {
                    ...
                    if ($scope.data._this.selections) {
                        ...
                        angular.forEach($scope.data._this.selections, function (value, key) {
                            if (value !== sel) {
                                newList.push(value);
                            }
                        });
                        ...
                        if (newList.length > 0) {
                            $scope.data._this.selections = newList;
                        } else {
                            delete $scope.data._this.selections;
                        }
            ...
            /* 이미지 프록시 테스트
            $http.jsonp('http://10.64.51.102:2000/proxy/image/test?callback=JSON_CALLBACK').success(function (data) {
    ...
    function bootstrap() {
        ...
        loadResources(resources, function () {
            ...
            loadResources([
                ...
                CONFIG.REMOTE_HOST + '/javascripts/web-clipper.util.js'
            ], function () {
